      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 p-8 sm:p-10 space-y-5">
          ...
          <div className="space-y-3 mt-6">
            <button
              onClick={() => toast.info("Google signup clicked!")}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-gray-200 rounded-3xl hover:bg-gray-50 hover:border-gray-300 hover:shadow-md transform hover:-translate-y-1 transition-all duration-200 cursor-pointer text-sm"
            >
            ...
            <button
              onClick={() => toast.info("Apple signup clicked!")}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black text-white rounded-3xl hover:bg-gray-900 hover:shadow-md transform hover:-translate-y-1 transition-all duration-200 cursor-pointer text-sm"
            >
